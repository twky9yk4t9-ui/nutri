...
Calm · glanceable · self-explanatory. Apple Health / Fitness product language: the app should read like a first-party iOS utility — instantly legible in 3 seconds without body text, quiet surfaces, one consistent SF-style glyph set, numbers as the heroes (tabular, with muted units). Zero persuasion, zero gamification, zero coaching voice.
